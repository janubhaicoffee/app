...
- Name: process_timeline.spec.js >> Process Timeline & Hover Effects >> 21. Verify grade badge section is present with AAA grade
- Location: tests\process_timeline.spec.js:51:3
...
Call log:
  ...
  - waiting for locator('.grade-section')
