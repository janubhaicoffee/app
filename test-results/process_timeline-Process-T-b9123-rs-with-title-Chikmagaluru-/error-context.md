...
- Name: process_timeline.spec.js >> Process Timeline & Hover Effects >> 20. Verify hero section renders with title "Chikmagaluru"
- Location: tests\process_timeline.spec.js:44:3
...
Locator: locator('.hero-title')
Expected substring: "Chikmagaluru"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.hero-title')
