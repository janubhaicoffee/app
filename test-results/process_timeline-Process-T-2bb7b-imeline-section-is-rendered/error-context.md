...
- Name: process_timeline.spec.js >> Process Timeline & Hover Effects >> 16. Verify process page timeline section is rendered
- Location: tests\process_timeline.spec.js:5:3
...
Locator: locator('text=From Farm to Cup')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=From Farm to Cup')
