...
export default function AdminBrandHeader() {
  ...
  return (
    <div className="admin-brand-header" style={{ padding: '16px 12px', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '8px', width: '100%' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <img src="/logo.png" alt="Janu Bhai Logo" style={{ width: '36px', height: '36px', objectFit: 'contain' }} />
          {!isSuperAdmin && (
            <div className="brand-text-container">
              <h2 style={{ fontSize: '18px', fontWeight: '800', margin: 0, color: '#ffffff' }}>Janu Bhai</h2>
              <p style={{ fontSize: '11px', margin: 0, opacity: 0.7, color: '#ffffff' }}>Admin Portal</p>
            </div>
          )}
        </div>
