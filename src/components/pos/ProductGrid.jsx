...
import { Coffee, Soup, CupSoda, UtensilsCrossed, Pizza, Beef, IceCream, ChefHat } from "lucide-react";
  ...
  return (
    <div className="pos-product-area">
      ...
      <div className="pos-product-grid">
        {loading ? (
          <div className="pos-loading" style={{ gridColumn: "1/-1" }}>Loading products...</div>
        ) : filtered.length === 0 ? (
          <div className="pos-empty" style={{ gridColumn: "1/-1" }}>No products found</div>
        ) : (
            ...
            >
              ...
              <div className="pos-product-price">
                ...
                {product.is_available === false && (
                  <span className="pos-stock-badge" style={{ background: "#ffebee", color: "#c62828" }}>Out of stock</span>
                )}
                {product.is_available !== false && product.current_stock !== undefined && product.current_stock <= 5 && (
