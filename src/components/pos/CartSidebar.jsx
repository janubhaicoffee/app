          ...
          items.map((item, idx) => (
            <div key={item.id || idx} className="pos-cart-item">
              <div className="pos-cart-item-info">
                ...
                <div className="pos-cart-item-price">₹{parseFloat(item.price || 0).toFixed(2)} each</div>
              </div>
              <div className="pos-qty-controls">
                <button className="pos-qty-btn" onClick={() => onUpdateQuantity(item.id, item.quantity - 1)}>
                  <Minus size={12} />
                </button>
