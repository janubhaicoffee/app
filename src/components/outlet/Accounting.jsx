    ...
    <div className="panel" data-testid="accounting-panel">
      ...
      <div className="stats-container">
        <div className="stat-box">
          <DollarSign
            size={18}
            style={{ color: '#38a169', margin: '0 auto 4px', display: 'block' }}
          />
          <div className="stat-label">Revenue</div>
          <div className="stat-value" style={{ color: '#38a169', fontSize: 20 }}>
        ...
        <div className="stat-box">
          <TrendingDown
            size={18}
            style={{ color: '#e53e3e', margin: '0 auto 4px', display: 'block' }}
          />
        ...
        <div className="stat-box">
          <TrendingUp
            size={18}
            style={{
              color: netProfit >= 0 ? '#3182ce' : '#e53e3e',
              margin: '0 auto 4px',
              display: 'block',
            }}
          />
          ...
          <div
            ...
            style={{ color: netProfit >= 0 ? '#3182ce' : '#e53e3e', fontSize: 20 }}
          >
        ...
        <div className="stat-box">
          ...
          <div
            ...
            style={{ color: '#805ad5', fontSize: 20 }}
          >
            {growth}
          </div>
        </div>
                  ...
                  >
                    <div className="outlet-list-item-info">
                      ...
                      <p
                        ...
                        style={{ margin: 0, fontSize: 11, color: '#718096' }}
                      >
