        ...
        {galleryImages.map((image) => (
          <div key={image.id} className="instagram-item">
            ...
            <div className="instagram-overlay">
              <svg viewBox="0 0 24 24" width="28" height="28" stroke="var(--text-warm-white)" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
            </div>
          </div>
        ))}
      </div>
