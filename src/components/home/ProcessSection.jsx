      ...
      <div className="container-premium">
        ...
        >
          ...
          <p className="body-luxury">
            Every single batch goes through four meticulous steps before it is delivered to your doorstep.
          </p>
        </motion.div>
        ...
        >
          <motion.div className="process-step" variants={cardVariants}>
            ...
            <p className="process-desc">Only the ripest cherries, selected by hand from our Chikmagaluru estate.</p>
          </motion.div>
          ...
          <motion.div className="process-step" variants={cardVariants}>
            ...
            <p className="process-desc">Naturally sun dried over days to develop rich, deep flavour profiles.</p>
          </motion.div>
          ...
          <motion.div className="process-step" variants={cardVariants}>
            ...
            <p className="process-desc">Small-batch roasted to perfection. Every batch tasted before it ships.</p>
          </motion.div>
          ...
          <motion.div className="process-step" variants={cardVariants}>
            ...
            <p className="process-desc">Sealed and shipped within days of roasting. Freshness guaranteed.</p>
          </motion.div>
        </motion.div>
      </div>
    </section>
