        ...
        >
          ...
          <div className="modal-body">
            ...
            <p className="warning-text">
              This is a custom-engineered variant with an intensity score of <strong>90/100</strong>
              . It contains an extremely concentrated dose of caffeine designed for critical focus.
            </p>
            <p>
              Before we can add this to your session, you must read and acknowledge the following
              safety statement:
            </p>
            ...
            >
              ...
              <span className="checkbox-label">
                I confirm that I understand this variant contains highly concentrated caffeine, and
                I agree to consume it responsibly.
              </span>
            </motion.label>
          </div>
