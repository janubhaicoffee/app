    ...
    <div style={{ maxWidth: '800px' }}>
        ...
        >
          <div>
            ...
            <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem' }}>
              <div style={{ flex: 1 }}>
                <label
                  style={{ fontWeight: 'bold', fontSize: '0.9rem', color: 'var(--text-secondary)' }}
                >
                  Store Name
                </label>
                <input
            ...
            <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem' }}>
              <div style={{ flex: 2 }}>
                ...
                <input
                  ...
                  placeholder="123 Coffee Street, Mumbai, MH"
                />
              </div>
              <div style={{ flex: 1 }}>
                <label
            ...
            <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem' }}>
              <div style={{ flex: 1 }}>
                ...
                <p style={{ fontSize: '0.8rem', color: '#666', marginTop: '5px' }}>
                  Orders above this qualify for free shipping.
                </p>
              </div>
              <div style={{ flex: 1 }}>
                <label
                ...
                />
                <p style={{ fontSize: '0.8rem', color: '#666', marginTop: '5px' }}>
                  Delivery fee for orders below the threshold.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{ flex: 1, maxWidth: '50%' }}>
              ...
              <p style={{ fontSize: '0.8rem', color: '#666', marginTop: '5px' }}>
                Keys are securely loaded from environment variables.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{ flex: 1 }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setSettings({ ...settings, admin_notification_emails: e.target.value })
                }
                style={{
                  width: '100%',
                  padding: '10px',
                ...
                placeholder="founder@janubhai.com, orders@janubhai.com"
              />
              <p style={{ fontSize: '0.8rem', color: '#666', marginTop: '5px' }}>
                These emails will receive alerts for new orders.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <p style={{ fontSize: '0.8rem', color: '#666', marginTop: '5px', marginLeft: '30px' }}>
              When enabled, the storefront checkout will be temporarily disabled.
            </p>
          </div>
      ...
      <div className="admin-card" style={{ marginTop: '2rem' }}>
        ...
        <p style={{ fontSize: '0.85rem', color: '#666', marginBottom: '1rem' }}>
          Add phone numbers for OTP login. Superadmins can also use email from SUPERADMIN_EMAILS
          env.
        </p>
