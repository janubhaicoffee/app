                  ...
                  <tr key={customer.id}>
                    <td>
                      {customer.profile_picture_url ? (
                        ...
                        <div style={{
                          ...
                          justifyContent: "center", fontSize: "0.8rem", fontWeight: 700, color: "#1a1a1a"
                        }}>
                    ...
                    <td>
                      ...
                      {customer.auth_provider && (
                        <span style={{
                          display: "inline-block", marginLeft: 6, padding: "0.1rem 0.4rem",
                          borderRadius: 3, fontSize: "0.65rem", fontWeight: 700,
                          background: customer.auth_provider === "facebook" ? "#1877F2" : customer.auth_provider === "google" ? "#DB4437" : "#666",
                          color: "#fff", textTransform: "uppercase", verticalAlign: "middle"
                        }}>
                          {customer.auth_provider}
                        </span>
                      )}
