              ...
              <div className="modal-body">
                ...
                {formData.code && formData.discount_value && (
                  ...
                  >
                    ...
                    <strong>{formData.code.toUpperCase()}</strong> &rarr;{' '}
                    {discountPreview(formData)}
                    {formData.min_order_amount && parseFloat(formData.min_order_amount) > 0 && (
                      <span> (min. ₹{formData.min_order_amount})</span>
                    )}
                  </div>
                )}
              </div>
