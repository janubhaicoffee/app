...
export default function ConsolidatedAnalytics() {
  ...
  const analysis = (() => {
    ...
    const outletPerformance = outlets
      .map((outlet) => {
        const localOrders = validOrders.filter(
  ...
  if (loading) {
    return (
      <div className="admin-loading">
        <div className="admin-spinner" /> Loading consolidated analytics...
      </div>
    );
  }
    ...
    <div>
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card blue">
          <h3>
            <BarChart3 size={14} style={{ display: 'inline', marginRight: 4 }} /> Avg Order Value
          </h3>
        ...
        <div className="stat-card gold">
          <h3>
            <Users size={14} style={{ display: 'inline', marginRight: 4 }} /> Total Staff
          </h3>
              ...
              <div>
                ...
                <div style={{ display: 'flex', gap: '1.5rem', marginTop: '0.5rem' }}>
                  <div>
                    ...
                    <br />
                    <strong>{formatINR(analysis.topOutlet.revenue)}</strong>
                  </div>
                  <div>
                    <span style={{ color: 'var(--text-secondary)', fontSize: '0.78rem' }}>
                      Orders
                    ...
                    <br />
                    <strong>{analysis.topOutlet.orders}</strong>
                  </div>
                  <div>
                    <span style={{ color: 'var(--text-secondary)', fontSize: '0.78rem' }}>
                      Staff
                    ...
                    <br />
                    <strong>{analysis.topOutlet.staff}</strong>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              <div>
                <div style={{ fontWeight: 700, fontSize: '1.1rem' }}>
                  {analysis.bottomOutlet.name}
                </div>
                <div style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>
                  Code: {analysis.bottomOutlet.code}
                </div>
                <div style={{ display: 'flex', gap: '1.5rem', marginTop: '0.5rem' }}>
                  <div>
                    <span style={{ color: 'var(--text-secondary)', fontSize: '0.78rem' }}>
                    ...
                    <br />
                    <strong>{formatINR(analysis.bottomOutlet.revenue)}</strong>
                  </div>
                  <div>
                    <span style={{ color: 'var(--text-secondary)', fontSize: '0.78rem' }}>
                      Orders
                    ...
                    <br />
                    <strong>{analysis.bottomOutlet.orders}</strong>
                  </div>
                  <div>
                    <span style={{ color: 'var(--text-secondary)', fontSize: '0.78rem' }}>
                      Staff
                    ...
                    <br />
                    <strong>{analysis.bottomOutlet.staff}</strong>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="admin-card">
        <div className="admin-card-header">
          ...
          >
            ...
            {Math.abs(analysis.momGrowth).toFixed(1)}%{' '}
            {analysis.momGrowth >= 0 ? 'growth' : 'decline'}
          </div>
        </div>
