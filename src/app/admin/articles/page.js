...
export default function AdminArticles() {
  ...
  const handleGenerateImage = () => {
    ...
    const encodedPrompt = encodeURIComponent(
      imagePrompt.trim() + ' premium quality photography coffee aesthetic',
    );
          ...
          >
            <h2 style={{ marginTop: 0, display: 'flex', justifyContent: 'space-between' }}>
              ...
              <div style={{ display: 'flex', gap: '0.5rem' }}>
                <button
                  type="button"
                  onClick={() => handleAITextEdit('polish')}
                ...
                >
                  {isAiEditing ? 'Processing...' : '✨ Polish Text'}
                </button>
                <button
                  type="button"
                  onClick={() => handleAITextEdit('expand')}
                  disabled={isAiEditing}
                  style={{
                ...
                >
                  {isAiEditing ? 'Processing...' : '✨ Expand Section'}
                </button>
              </div>
            </h2>
                    ...
                    >
                      <button
                        ...
                        style={{
                          padding: '4px 12px',
                          border: 'none',
                          background: !previewMode ? 'var(--accent-red)' : 'transparent',
