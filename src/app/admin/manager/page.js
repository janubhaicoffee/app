        ...
        <div className="manager-panel">
          ...
          {eventsList.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '50px 20px', background: 'rgba(0,0,0,0.2)', border: '1px dashed rgba(212,163,89,0.3)', borderRadius: '16px' }}>
              ...
              <h4 style={{ color: '#f7e7ce', margin: '0 0 4px', fontSize: '1.05rem' }}>No Scheduled Events</h4>
              <p style={{ color: '#a89f91', fontSize: '0.84rem', margin: 0 }}>
                When Growth & Brand Leader schedules events, the live guest attendance roster will appear here.
              </p>
            </div>
          ) : (
