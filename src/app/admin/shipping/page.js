                    ...
                    <tr key={zone.id}>
                      ...
                      <td>
                        <div className="cell-actions">
                          <button className="admin-btn-sm" onClick={() => openModal(zone)}>
                            Edit
                          </button>
                          ...
                          <button
                            className={`admin-btn-sm ${confirmDelete?.id === zone.id ? 'btn-confirming' : ''}`}
                    ...
                    <div className="states-picker">
                      {INDIAN_STATES.map((state) => {
                        ...
                        return (
                          <label
                            key={state}
                            className={`state-chip ${selected ? 'selected' : ''}`}
