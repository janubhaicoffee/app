  ...
  return (
    <div className="admin-products-page">
      ...
      <div className="admin-card">
        <div className="admin-table-wrap">
          <table className="admin-table">
            ...
            <tbody>
              {loading ? (
                <tr><td colSpan="7" style={{ textAlign: "center", padding: "3rem", color: "var(--text-secondary)" }}>Loading...</td></tr>
                  ...
                  <tr key={product.id} className={product.status === "draft" ? "row-draft" : product.status === "archived" ? "row-archived" : ""}>
                    ...
                    <td>
                      <div className="product-name-cell">
                        ...
                        <span className="product-id-text">{product.id} {product.featured && <Star size={11} fill="var(--accent-gold)" color="var(--accent-gold)" />}</span>
                      </div>
                    </td>
                    ...
                    <td>
                      <div className="cell-actions">
                        <Link href={`/admin/products/${product.id}`} className="admin-btn-sm" title="Edit">
                          <Pencil size={13} /> Edit
                        </Link>
      ...
      <style jsx global>{`
        ...
        .admin-loading { padding: 3rem; text-align: center; color: var(--text-secondary); font-size: 1.1rem; }
        .admin-toast {
        ...
        .admin-toolbar { display: flex; align-items: center; gap: 1rem; margin-bottom: 1.5rem; flex-wrap: wrap; }
        .admin-search {
        ...
        .admin-search input { border: none; outline: none; background: transparent; width: 100%; font-size: 0.9rem; }
        ...
        .product-name-cell { display: flex; flex-direction: column; gap: 2px; align-items: flex-start; }
        .product-name-text { font-weight: 700; font-size: 0.95rem; }
        .product-id-text { font-size: 0.75rem; color: #999; display: flex; align-items: center; gap: 4px; }
