  ...
  if (loading) {
    return (
      <div className="admin-loading">
        <div className="admin-spinner" /> Loading staff...
      </div>
    );
  }
    ...
    <div>
      ...
      {filtered.length === 0 ? (
        <div className="empty-state">
          <Users size={48} />
          <h3>
            {search || filterOutlet !== 'all' ? 'No staff match your filters' : 'No staff yet'}
          </h3>
          <p>
            {search || filterOutlet !== 'all'
              ? 'Try different search terms or filters'
              : 'Add staff members to manage outlet operations'}
          </p>
        </div>
      ) : (
        <div
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: member.is_active !== false ? '#721c24' : '#155724',
                      cursor: 'pointer',
                      borderRadius: 6,
                      fontWeight: 600,
                      fontSize: '0.78rem',
