...
function TimelineNode({ step, index }) {
  ...
  return (
    ...
    >
      ...
      >
        <video src={step.videoUrl} autoPlay muted loop playsInline className="step-loop-video" />
        <motion.div
...
export default function ProcessPage() {
  return (
    <main className="process-page">
      ...
      <section className="process-hero">
        ...
        >
          ...
          <p className="hero-description">
            Our coffee comes from the lush hills of Chikmagaluru, Karnataka one of India&apos;s most
            celebrated coffee growing regions, known for its rich soil, perfect climate and passion
            for quality.
          </p>
        </motion.div>
      </section>
      ...
      >
        <p>
          Grown at high altitudes and nurtured with care, our Chikmagalur Arabica beans are AAA
          grade and carefully sorted for consistent quality. Each cup delivers a perfect balance of
          aroma, body and flavour the way coffee was meant to be.
        </p>
