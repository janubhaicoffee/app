      ...
      <div className="container legal-container" style={{ maxWidth: '900px' }}>
        ...
        >
          <div>
            <h2>Get in Touch</h2>
            <p>
              We'd love to hear from you! Whether you have a question about our coffee, an order, or
            ...
            {status && (
              <div
                style={{
                  padding: '1rem',
                  marginTop: '1rem',
                  background: status.type === 'success' ? '#2ecc7133' : '#e74c3c33',
            ...
            <ul>
              <li>
                <strong>Email:</strong> hello@janubhai.com
              </li>
              <li>
