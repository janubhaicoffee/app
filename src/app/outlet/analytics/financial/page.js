...
export default function FinancialAnalytics() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const prevStart = new Date(new Date(start).getTime() - rangeLen - 86400000)
        .toISOString()
        .split('T')[0];
      ...
      <div className="outlet-page-header">
        <div>
          ...
          <p className="outlet-page-subtitle">
            Deep dive into revenue, expenses, and profitability
          </p>
        </div>
            ...
            <AreaChart
              data={
                revExpChart.length > 0
                  ? revExpChart
                  : [{ date: 'No data', revenue: 0, expenses: 0 }]
              }
            >
