    ...
    <div>
      <div className="outlet-page-header">
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          ...
          <button className="outlet-btn outline sm" onClick={fetchExpenses}>
            <RefreshCw size={14} />
          </button>
        </div>
      </div>
      ...
      <div className="outlet-stats-grid">
        ...
        <div className="outlet-stat-card">
          ...
          <div className="outlet-stat-info">
            <h3>{formatCurrency(paidExpenses)}</h3>
            <p>Paid</p>
          </div>
        </div>
        <div className="outlet-stat-card">
          ...
          <div className="outlet-stat-info">
            <h3>{formatCurrency(pendingExpenses)}</h3>
            <p>Pending</p>
          </div>
        </div>
        <div className="outlet-stat-card">
      ...
      {showForm && (
        <form className="outlet-form" onSubmit={handleAddExpense}>
          ...
          <div className="form-group" style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            />
            <label htmlFor="recurring" style={{ margin: 0 }}>
              Recurring expense
            </label>
          </div>
        ...
        <div className="outlet-card">
          ...
          >
            ...
            <span style={{ fontSize: 13, color: '#92400e' }}>
              Rent & utilities are tracked here
            </span>
          </div>
              ...
              {expenses.length === 0 ? (
                ...
                expenses.map((exp) => (
                  <tr key={exp.id}>
                    ...
                    <td>
                      <span className="outlet-badge blue">{exp.category}</span>
                    </td>
                    ...
                    <td>
                      <span
                        className={`outlet-badge ${exp.status === 'paid' ? 'green' : 'yellow'}`}
                      >
                        {exp.status || 'pending'}
                      </span>
                    </td>
                    <td>
                      {exp.status !== 'paid' && (
                        <button
                          className="outlet-btn success sm"
