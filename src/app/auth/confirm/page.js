  ...
  return (
    <main className="auth-page">
      <div className="container auth-container">
        <div className="auth-box vintage-border" style={{ textAlign: 'center', padding: '3rem 2rem' }}>
          
          <div className="animation-container" style={{ minHeight: '150px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            {status === "confirming" ? (
              <div className="fade-in">
                <Loader2 className="spin" size={48} color="var(--primary-color)" style={{ marginBottom: '1rem' }} />
              ...
              <div className="fade-in pop-in">
                <CheckCircle2 size={64} color="var(--accent-red)" style={{ marginBottom: '1rem' }} />
