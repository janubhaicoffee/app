        ...
        <form onSubmit={handleSearch} style={{ padding: "20px" }}>
          <div style={{ display: "flex", gap: 10 }}>
            <input
              ...
              style={{ flex: 1, padding: "12px", border: "2px solid var(--border-color)", fontSize: "1rem" }}
            />
          ...
          <div style={{ padding: "0 20px 20px" }}>
            <div className="pos-panel" style={{ marginBottom: 16 }}>
              ...
              <div style={{ display: "flex", gap: 20, flexWrap: "wrap", fontSize: 13 }}>
                ...
                {customer.email && <span><User size={14} /> {customer.email}</span>}
              </div>
              <div style={{ display: "flex", gap: 20, marginTop: 12, fontSize: 13 }}>
                <span><strong>Orders:</strong> {customer.total_orders || 0}</span>
                <span><strong>Spent:</strong> ₹{parseFloat(customer.total_spent || 0).toFixed(2)}</span>
                <span><strong>Visits:</strong> {customer.visit_count || 0}</span>
              </div>
