...
describe('cartHydration', () => {
  ...
  describe('serializeCart', () => {
    ...
    it('should serialize cart items to base64url', () => {
      const items = [
        { id: 'instantcoffee', quantity: 2, variantSlug: null, variant_id: null, subscription: null, isGift: false },
      ];
  ...
  describe('deserializeCart', () => {
    ...
    it('should round-trip serialize and deserialize', () => {
      const items = [
        { id: 'instantcoffee', quantity: 2, variantSlug: null, variant_id: null, subscription: 'weekly', isGift: false },
        { id: 'coffee-beans', quantity: 1, variantSlug: 'medium-roast', variant_id: null, subscription: null, isGift: true },
      ];
