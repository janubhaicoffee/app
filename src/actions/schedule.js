  ...
  const brewTimeline = [
    {
      ...
      recommendedBlend:
        sleepHours < 6
          ? 'Thodi Hard - Extra Intense (Intensity 90)'
          : 'Thodi Hard - Medium Roast (Intensity 50)',
      rationale:
        sleepHours < 6
          ? 'Mitigates accumulated sleep debt deficits.'
          : 'Standard morning performance baseline.',
    },
    {
