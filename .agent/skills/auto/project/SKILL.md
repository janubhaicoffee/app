---
name: project
description: "Project for app. 21 gotchas, 126 conventions, 1 fixes."
domain: project
triggers:
  - glob: "**/*"
autoGenerated: true
...
Auto-compiled from **158 real patterns** in **app**. This skill is auto-routed to agents when working on project files.
...
| ❌ Don't | Details |
|----------|----------|
| Low cohesion detected in Domain Cluster 7 | Cluster 7 (18 nodes) has a very low cohesion score (0.06). This suggests the community is a "spaghet |
| Surprising bridge detected: appdata.ts → supabase. | A rare connection exists between Domain Cluster undefined and Cluster undefined. This bridge may ind |
...
---
*Auto-generated by BrainSync 🧠 | 158 patterns | 2026-05-07*
